...
from src.infrastructure.user_repository import create_user, get_user_by_name
from src.infrastructure.webauthn_challenge_repository import save_challenge, take_challenge
from src.infrastructure.webauthn_repository import (
    create_credential,
...
from src.presentation.schema.auth import (
