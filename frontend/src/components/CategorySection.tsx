  ...
  return (
    <>
      ...
      <div className="rounded-2xl bg-white p-5 shadow-sm dark:bg-gray-800">
        <p className="mb-3 text-xs text-gray-500 dark:text-gray-400">Category</p>
        ...
        {categories.length > 0 ? (
          <div className="mt-3 divide-y divide-gray-100 dark:divide-gray-700">
            {categories.map((c) => (
              <div key={c.uuid} className="flex items-center gap-3 py-3">
                {editing?.uuid === c.uuid ? (
          ...
          <p className="py-4 text-center text-sm text-gray-400 dark:text-gray-500">No categories</p>
        )}
      </div>
